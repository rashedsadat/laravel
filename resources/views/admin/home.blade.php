                                        ...
                                        <div class="col-6 pr-2">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                ...
                                                <img class="dt-avatar size-30"
                                                    src="assets/images/user-avatar/nikki.jpg"
                                                    alt="Mila Alba">
                                                <!-- /avatar -->
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-6 pr-2">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                <!-- Avatar -->
                                                <img class="dt-avatar size-30"
                                                    src="assets/images/user-avatar/garry-sobars.jpg"
                                                    alt="Pukhraj">
                                                <!-- /avatar -->
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-6 pr-2">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                <!-- Avatar -->
                                                <img class="dt-avatar size-30"
                                                    src="assets/images/user-avatar/domnic-harris.jpg"
                                                    alt="crish Harris">
                                                <!-- /avatar -->
                            ...
                            <div class="dt-card__body bg-gradient-dark-purple">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <p class="mb-xl-0 display-5 font-weight-medium">Now, your account is
                                            on your fingers</p>
                                    </div>
                                    <!-- /grid item -->
                        ...
                        <div class="media-list">
                            ...
                            <div class="media media-news">
                                ...
                                <img class="img-fluid rounded-xl"
                                    src="assets/images/dashboard/bitcoin-cryptocurrency-trader.jpg"
                                    alt="Crypto Currency">
                                <!-- /image -->
                            ...
                            <div class="media media-news">
                                ...
                                <!-- Image -->
                                <img class="img-fluid rounded-xl"
                                    src="assets/images/dashboard/bitcoin-in-the-mousetrap.jpg"
                                    alt="Crypto Currency">
                                <!-- /image -->
                            ...
                            <div class="media media-news">
                                ...
                                <!-- Image -->
                                <img class="img-fluid rounded-xl"
                                    src="assets/images/dashboard/concept-of-blockchain.jpg"
                                    alt="Block Chain">
                                <!-- /image -->
